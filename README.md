...
**MeowTool** — это **CLI**-инструмент, который содержит в себе полезные функции для работы с прокси и куки роблокс.
...
- **Proxy Checker**: проверит прокси на работоспособность
  - Формат прокси: `protocol://ip:port` или `protocol://ip:port:username:password`
...
- **Roblox Cookie Checker**: проверит куки на все или только некоторые данные
  ...
  - Поддержка прокси
    - Формат прокси: `protocol://ip:port:username:password`
    - Поддерживаемые сетевые протоколы: `IPv4`
    - Поддерживаемые прикладные протоколы: `http(s)`, `socks4/5`
...
- **Roblox Cookie Sorter**: собирает все куки из множества файлов в один
...
- **Transaction Analysis**: собирает всю информацию о транзакциях выбранных плейсов

...
### Навигация
При перемещении по меню, буквенные коды можно вписывать по разному, например, чтобы перейти в настройки, можно использовать такие клавиши: `S`, `s`, `Ы`, `ы`

### Горячие клавиши
*Их нужно ввести в строку ввода так, как вы перемещаетесь по меню*

...
async def parsePlaceItemsRoblox(info: dict[str, str], placeId: str, columnarHeaders: list):
    ...
    try:
        ...
        if not response:
            return errorOrCorrectHandler(True, info['errorHasNo'], info['visualPath'])
